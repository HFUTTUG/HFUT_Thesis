...
{ustctug/ustcthesis} 基础上编写，其前身是中国科学技术大学本科论文模板和中国科学技术大学研究生论文模板。
2021年5月，\href{https://github.com/LaureatePoet}{LaureatePoet}和\href{https://github.com/HowardZorn}{Fw[a]rd}基于合肥工业大学本科生和研究生学位论文的相关要求，开发了本模板的 v1.0.0 版本。

下载地址：
\begin{itemize}
  \item GitHub Releases：\url{https://github.com/HFUTTUG/HFUT_Thesis/releases}
  \item Overleaf 模板：\url{https://www.overleaf.com/}
\end{itemize}
